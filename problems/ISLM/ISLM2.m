...
elseif strcmpi(Model,'IS dynamics') && Simulation==1
    ...
    u(:,1) = t;
    u(:,2) = A(begin:finish,7)+A(begin:finish,10)+ A(begin:finish,12) + A(begin:finish,17); % sum of Columns H: Personal Consumption;
    % Column K: Government Expenditure; Column M: Net Exports; and Column R: Net Domestic Investment
