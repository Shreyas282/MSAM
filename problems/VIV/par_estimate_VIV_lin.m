...
function cons = par_estimate_VIV_lin(output_focus)
%  close all
%  clear
...
if nargin<1, output_focus=[2]; end
...
% eps = out.eps;
% eps = 0.3;
y0 = -out.ddy_50s(output_focus,:)'*A/D;
